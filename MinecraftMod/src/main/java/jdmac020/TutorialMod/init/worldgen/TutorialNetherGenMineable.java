...
public class TutorialNetherGenMineable extends WorldGenerator
{
    ...
    public TutorialNetherGenMineable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.NETHERRACK));
    }

    public TutorialNetherGenMineable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
