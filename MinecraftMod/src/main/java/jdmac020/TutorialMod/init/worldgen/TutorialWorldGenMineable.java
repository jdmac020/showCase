...
public class TutorialWorldGenMineable extends WorldGenerator
{
    ...
    public TutorialWorldGenMineable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.STONE));
    }

    public TutorialWorldGenMineable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
