...
namespace MacGregorLab12.Models
{
     ...
     * Class 
     * Description: The freshly deserialized-from-JSON POCO object that stores the currency codes and their full name strings.
     */

    /// <summary>
    /// Deserialized-from-JSON object that provides currencies codes and their full description string.
    /// </summary>
